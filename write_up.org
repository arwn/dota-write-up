...
** Genetic Algorithms
   ...
   once and getting a result back, we want that result to be fed back into
   ...
   For the sake of clarity I'm not explaining the nitty gritty of how
   genes are selected but if you want to learn more about genetic
   algorithms Wikipedia has a good article [[https://en.wikipedia.org/wiki/Genetic_algorithm][here]]. Genetic algorithms are just
   ...
   cumulative score of how well the bot did with the new mutated
